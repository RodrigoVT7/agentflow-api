...
exports.validationSchemas = exports.sanitizeText = exports.isSafeText = exports.isValidUrl = exports.isValidPhoneNumber = exports.isValidEmail = exports.validateRequest = void 0;
...
const validateRequest = (schema, source = 'body') => {
    return (req, res, next) => {
        ...
        if (errors.length > 0) {
            next(new error_middleware_1.HttpError(`Validación fallida: ${errors.join('. ')}`, 400));
        }
        else {
            next();
        }
...
exports.validationSchemas = {
    ...
    sendMessage: {
        ...
        message: {
            ...
            min: 1,
            max: 4000,
            custom: (value) => (0, exports.isSafeText)(value) || 'El mensaje contiene contenido no permitido'
        }
    },
    updatePriority: {
        conversationId: {
