...
class ConversationRepository {
    constructor() {
        switch (database_config_1.default.type) {
            ...
            default:
                this.repository = new memory_repository_1.MemoryRepository('conversations', path_1.default.join(__dirname, '../../../data/conversations.json'));
                break;
        }
    }
    create(data) {
     ...
     */
    findInactiveConversations(thresholdTime) {
        return __awaiter(this, void 0, void 0, function* () {
            const allConversations = yield this.repository.findAll();
            const now = Date.now();
            return allConversations.filter(conversation => now - conversation.lastActivity > thresholdTime);
        });
    }
    /**
    ...
    findByPhoneNumber(from) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.repository.findOne({ from });
        });
    }
}
